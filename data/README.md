...
Reproduction covers the temporal analyses backed by the source files in this release. Additional manually recorded data are available from the corresponding author on reasonable request.
